$(document).ready(function(){
	...
	$.getJSON('./scripts/data.json', function(jsonObj) {
		console.log(jsonObj);

		// Check if JSON data is successfully retrieved
		if (jsonObj && jsonObj.pageTextData) {
			...
			$('#title_About').html('<h1>' + jsonObj.pageTextData[9].AboutTitle + '</h1>');
			$('#description_About').html('<h5>' + jsonObj.pageTextData[9].AboutDescription.replace(/\n/g, '<br>') + '</h5>');
