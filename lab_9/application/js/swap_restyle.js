...
$(document).ready(function() {
	...
	function selectPage() {
		...
		$('#navModels').click(function(){
			...
			$("#x3dBackground").css("background-image", "url('../application/assets/x3d/maps/cola_back.jpg')");
		});
	}
...
function spriteDescription() {
    $("button").click(function(){
		...
		$("#x3dBackground").css("background-image", "url('../application/assets/x3d/maps/sprite_back.jpg')");
    }); 
}
...
function pepperDescription() {
    $("button").click(function(){
		...
		$("#x3dBackground").css("background-image", "url('../application/assets/x3d/maps/pepper_back.jpg')");
    }); 
}
...
function changeLook() {
    ...
    switch (counter) {
        case 1:
            ...
            document.getElementById('main_3d_image').style.backgroundImage = 'url(../application/assets/images/site_images/main_3D2.jpg)';
            break;
        case 2:
            ...
            document.getElementById('main_3d_image').style.backgroundImage = 'url(../application/assets/images/site_images/main_3D3.jpg)';
            break;
        case 3:
            ...
            document.getElementById('main_3d_image').style.backgroundImage = 'url(../application/assets/images/site_images/main_3D4.jpg)';
            break;
        case 4:
            counter = 0;
            ...
            document.getElementById('main_3d_image').style.backgroundImage = 'url(../application/assets/images/site_images/main_3D1.jpg)';
            break;
    }
}
...
function changeBack() {
	...
	document.getElementById('main_3d_image').style.backgroundImage = 'url(../application/assets/images/site_images/main_3D.jpg)';
}